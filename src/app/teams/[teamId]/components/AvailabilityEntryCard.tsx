...
export function AvailabilityEntryCard({ teamId }: AvailabilityEntryCardProps) {
  ...
  return (
    ...
    >
      <div className="w-9 h-9 rounded-full bg-primary/10 flex items-center justify-center shrink-0 text-[16px]">
        🗓️
      </div>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          <p className="text-[14px] font-semibold text-ink">가능한 시간 투표</p>
          <span className="text-[9px] font-bold text-white bg-status-red px-1.5 py-0.5 rounded-full leading-none shrink-0">
            NEW
          </span>
        </div>
